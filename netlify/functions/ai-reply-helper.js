...
`.trim();
    ...
    await recordUsage(event, context, aiResult.data, { feature:"REPLY_HELPER", uiLang, documentLang:"UNKNOWN", accessType:String(body.accessType||"UNKNOWN").toUpperCase(), model:aiResult.data?.model||"gpt-4o-mini" });
